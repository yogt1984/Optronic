...
enum class Code : std::uint16_t {
  ...
  invalid_arg = 0x0001, timeout = 0x0002, not_ready = 0x0003,
  io = 0x0004, no_mem = 0x0005,

  cfg_parse = 0x0201, cfg_schema = 0x0202, cfg_range = 0x0203,

  hal_open = 0x0301, hal_map = 0x0302,
  hal_id_mismatch = 0x0303, hal_irq_timeout = 0x0304,

  vid_build = 0x0401, vid_state = 0x0402, vid_encoder_lost = 0x0403,
  vid_stall = 0x0404, vid_caps = 0x0405,

  bit_poweron = 0x0501, bit_continuous = 0x0502,
